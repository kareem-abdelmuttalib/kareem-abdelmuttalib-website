...
const skills = [
  {
    ...
    technologies: [
      {
        name: "Burp Suite",
        icon: <SiBurpsuite className="inline mr-1 text-[#FF6633]" />,
      },
      { name: "OWASP ZAP", icon: <SiOwasp className="inline mr-1" /> },
      {
        name: "Metasploit",
        icon: <SiMetasploit className="inline mr-1 text-[#E95420]" />,
      },
    ],
  },
  {
    ...
    technologies: [
      {
        name: "Kali Linux",
        icon: <SiKaliLinux className="inline mr-1 text-[#557C94]" />,
      },
      {
        name: "Nmap",
        icon: <FaNetworkWired className="inline mr-1" />,
      },
      {
        name: "Wireshark",
        icon: <SiWireshark className="inline mr-1 text-[#1679A7]" />,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    technologies: [
      {
        name: "Python",
        icon: <SiPython className="inline mr-1 text-[#3776AB]" />,
      },
  ...
  },
  {
    ...
    technologies: [
      ...
      {
        name: "Docker",
        icon: <SiDocker className="inline mr-1 text-[#2496ED]" />,
      },
    ],
  },
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-text-secondary max-w-2xl mx-auto">
            I specialize in offensive security and defensive measures. Here are
